...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Juan Maulana
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Hi, I'm Juan Rizky Maulana, merging web development and data science. Explore my portfolio for innovative solutions. Let's collaborate for digital innovation.</p>
