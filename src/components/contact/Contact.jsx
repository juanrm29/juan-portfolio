  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">juanmaulana29@gmail.com</span>

              <a href="mailto:ameenair6@gmail.com" className="contact__button">
                Write me{" "}
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Juan Rizky Maulana</span>
        ...
        <div className="contact__content">
          <h3 className="contact__title">Feel free to message</h3>
